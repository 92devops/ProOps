...
class Pagination:
    ...
    def __init__(self, request, data, search_data, page_parm="page", page_size=3, plus=3):
    ...
    def Html(self):
        ...
        for i in range(start_page, end_page + 1):
            if i == self.page:
                ele = '<li class="active"><a href="?{}={}&q={}">{}</a></li>'.format(self.page_parm, i, self.search_data,i)
            else:
